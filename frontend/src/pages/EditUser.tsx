...
const EditUser: React.FC = () => {
  ...
  const loadUser = async () => {
    try {
      ...
      setToast({
        show: true,
        message: error.response?.data?.error || 'Error loading user',
        color: 'danger'
      });
      setTimeout(() => history.push('/manage-users'), 2000);
    } finally {
      setIsLoading(false);
    }
  };
    ...
    return (
      <>
        ...
        <IonPage id="main-content">
          ...
          <IonContent>
            <IonLoading isOpen={true} message="Loading user..." />
          </IonContent>
        </IonPage>
      </>
    );
    ...
    <>
      ...
      <IonPage id="main-content">
        ...
        <IonContent>
          ...
          <IonLoading isOpen={isSaving} message="Updating user..." />
          <IonToast
            isOpen={toast.show}
